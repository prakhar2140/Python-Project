...
import os
root = Tk()
image = PhotoImage(file="./img/background (1).png")
...
welcome_label = Label(text="Canteen_Management_Systumm", bg="#2F6C60", font=("Trebuchet Ms", 15, "bold"), fg="#FFFFFF")
welcome_label.place(x=130, y=25)
 
bg_label = Label(root, image=image, bg="#2F6C60")
bg_label.place(x=130, y=65)

progress_label = Label(root, text="Loading...", font=("Trebuchet Ms", 13, "bold"), fg="#FFFFFF", bg="#2F6C60")
...
def top():
    root.withdraw()
    os.system("python Canteen_management_system.py")
    root.destroy()
